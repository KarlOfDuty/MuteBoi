# MuteBoi [![Release](https://img.shields.io/github/release/KarlofDuty/MuteBoi.svg)](https://github.com/KarlOfDuty/MuteBoi/releases) [![Discord Server](https://img.shields.io/discord/430468637183442945.svg?label=discord)](https://discord.gg/C5qMvkj)

> [!CAUTION]
> **This repo is obsolete. Please go to the new repo here instead: [RoleBoi](https://github.com/KarlOfDuty/RoleBoi)**
